    ...
    <div className="field-noche relative grid min-h-svh place-items-center overflow-hidden px-6 text-center">
      <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" className="h-full w-full opacity-40" focusable="false">
          <path d="M-100,600 C300,480 600,720 1000,580 C1240,500 1400,620 1560,540" fill="none" stroke="var(--color-petrol)" strokeWidth="70" strokeLinecap="round" />
          <path d="M-100,500 C350,400 650,600 1100,470 C1300,410 1440,500 1560,440" fill="none" stroke="var(--color-lima)" strokeWidth="26" strokeLinecap="round" />
        </svg>
      </div>
      <div className="relative">
        <p className="text-sm font-bold uppercase tracking-[0.3em] text-lima">{t("notFound.count")}</p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Link
            ...
            className="rounded-full bg-lima px-7 py-3.5 font-bold text-noche transition-colors hover:bg-lima-deep"
          >
            {t("notFound.cta")}
          </Link>
          <Link to={pathFor("home", otherLocale)} className="font-semibold text-crudo underline underline-offset-4 hover:text-lima">
