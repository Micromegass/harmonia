...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 grid h-14 w-14 place-items-center rounded-full bg-wa text-noche shadow-lift transition-transform hover:scale-110 focus-visible:scale-110 motion-reduce:transition-none"
    >
