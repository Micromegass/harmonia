        ...
        <div className="mx-auto max-w-4xl px-5 py-16 text-center sm:px-8 sm:py-20">
          ...
          <Reveal beats={2} className="mt-8">
            <a
              ...
              className="inline-block rounded-full bg-noche px-8 py-4 text-lg font-bold text-lima transition-transform hover:scale-105 active:scale-95 motion-reduce:transition-none"
            >
