...
- **Hero video card**: a large soft-edged (2.2rem) 9:15 video window laid into the current at -2.5°, petrol color-grade + edge vignette, 8-bar float; three field lines + a runner re-drawn in front so the current weaves around it. Muted/looping/decorative; still frame under reduced motion.
